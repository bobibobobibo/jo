...
**Tests**: TDD is MANDATORY. Every user story MUST define tests first, ensure tests fail, then implement.
...
- When a task is completed, its checkbox MUST be updated to `[x]` immediately

## Path Conventions

- **Single project**: `src/`, `tests/` at repository root
- **Web app (default static)**: `frontend/src/`, `frontend/public/`, `frontend/tests/`
...
- [ ] T004 Define phase git checkpoint commands and commit strategy in [path]
...
- [ ] T011 Add guard task to protect spec artifacts from deletion/overwrite
...
- [ ] T020 [US1] Run git checkpoint (`git status`, tests, commit)
...
- [ ] T027 [US2] Run git checkpoint (`git status`, tests, commit)
...
- [ ] T033 [US3] Run git checkpoint (`git status`, tests, commit)
...
- Never delete or overwrite spec artifacts (`spec.md`, `plan.md`, `tasks.md`) during implementation
- For website projects, prefer GitHub Pages deployable static frontend unless spec explicitly requires backend
